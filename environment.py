...
#before_all= nume de metoda standardizat care da sistemului informatii ca acele instructiuni trebuie
# executate inainte de executarea unui scenariu


from pages.sign_in_page import Sign_In_Page
from browser import Browser
from pages.forgot_password_page import Forgot_Pass_Page
...
def before_all(context):
    ...
    context.forgot_pass = Forgot_Pass_Page()
